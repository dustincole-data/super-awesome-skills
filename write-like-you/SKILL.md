---
name: write-like-you
description: Use when drafting or editing anything in your own voice, or when checking a draft for corny AI tells before it ships.
---
...
1. Gather 5-10 real pieces you wrote and are happy with.
2. For each voice move you notice, **paste a real quote** as the exemplar. Show the move,
   never describe it.
3. List the **banned tells**: words and cadences that would never be yours. Reading a few
   AI drafts of your topic surfaces them fast.
4. Fill the slots below, deleting this guidance as each is done. When you can't ground a
   rule in a real sentence, cut the rule.

**How to improve this over time:** use the `write-like-you-tune` skill. Hand it one
before/after pair (an AI draft vs. your rewrite of the same piece) and it proposes
gated, general edits to this file.
...
Paste 4-8 real quotes from your writing. Label each with the move it proves. These do
more work than any rule, and a quote can't overfit.
...
Near-universal AI slop tells, safe as defaults. Remove any that are honestly *yours*, and
add the ones specific to you.

| Banned | Why it's not you | Do instead |
|--------|------------------|------------|
| **Hype words** ("game-changer", "revolutionary", "unlock", "supercharge", "10x", "seamless") | Vendor register | Plain words + a concrete specific |
| **Rule-of-three slop** ("faster, cheaper, smarter") | Marketing cadence | One real specific, or a real list of real things |
| **"In a world where…" / grand sincere framing** | Performs importance | State the plain fact, let it carry |
| **Tidy life-lesson endings** | Resolves what should stay open | End on an honest open note |
